 ...
 * buffering operations in declarative APIs, e.g. {@link Flux}.
 *
 ...
 * {@link Flux#doOnDiscard} that also take care of cancel and error signals, or
 * otherwise {@link #releaseAndClear()} can be used.
 *
