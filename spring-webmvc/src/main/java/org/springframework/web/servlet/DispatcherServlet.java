...
public class DispatcherServlet extends FrameworkServlet {
	...
	protected void render(ModelAndView mv, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		View view = resolveView(mv, request, locale);
		if (view instanceof SmartView smartView) {
			smartView.initNestedViews(mav -> resolveView(mav, request, locale));
		}
	...
	private View resolveView(ModelAndView mv, HttpServletRequest request, Locale locale) throws Exception {
		View view;
