...
public class HttpMediaTypeNotSupportedException extends HttpMediaTypeException implements ErrorResponse {
	 ...
	 */
	public HttpMediaTypeNotSupportedException(@Nullable MediaType contentType,
			List<MediaType> supportedMediaTypes, @Nullable HttpMethod httpMethod, String msg) {
	...
	public ProblemDetail getBody() {
		return ProblemDetail.forRawStatusCode(getRawStatusCode()).withDetail(getMessage());
	}
