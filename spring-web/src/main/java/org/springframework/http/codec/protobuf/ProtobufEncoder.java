 ...
 *
 * TODO Support text format at least on encoding side (not sure stream decoding makes sense)
 *
 * @author Sébastien Deleuze
 * @since 5.1
 * @see ProtobufDecoder
 */
public class ProtobufEncoder extends ProtobufCodecSupport implements Encoder<Message> {
