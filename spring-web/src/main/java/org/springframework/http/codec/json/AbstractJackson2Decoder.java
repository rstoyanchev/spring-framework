...
public abstract class AbstractJackson2Decoder extends Jackson2CodecSupport implements HttpMessageDecoder<Object> {
	 ...
	 * is either the size the entire input when decoding as a whole to a single
	 * Object or Collection. Or it could be the size of one top-level JSON
	 * object within a JSON stream. When the limit is exceeded,
