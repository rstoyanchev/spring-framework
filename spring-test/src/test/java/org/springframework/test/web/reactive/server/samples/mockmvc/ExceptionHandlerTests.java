...
package org.springframework.test.web.reactive.server.samples.mockmvc;
...
import org.springframework.test.web.reactive.server.MockMvcTestClient;
	...
	class RestTests {
		...
		void noException() {
			WebTestClient client = MockMvcTestClient.bindToController(new RestPersonController())
					.setControllerAdvice(new RestPersonControllerExceptionHandler())
					.build();
